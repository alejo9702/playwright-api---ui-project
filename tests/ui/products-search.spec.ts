...
test.describe('Products Search UI Tests', () => {
  ...
  test.describe('@ui @smoke Search Functionality', () => {
  ...
  test.describe('@ui Product Cards', () => {
  ...
  test.describe('@ui Filtering and Sorting', () => {
  ...
  test.describe('@ui Performance and Loading', () => {
